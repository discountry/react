...
> This is not the official react repository. We've been working on translate the offical react docs in Chinese. Because of the modification of original docs markdown files, this branch can not be merged to the `facebook/react` .
